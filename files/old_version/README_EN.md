...
# NOT mysc... my-scrcpy already exists in pypi...
...
7. **~/.mysc/** Localization configuration file, including running config file *.db, keypress mapping file tps/*.json
8. **tools/*** CLI Tools
...
from mysc.core import *
from mysc.utils import *
